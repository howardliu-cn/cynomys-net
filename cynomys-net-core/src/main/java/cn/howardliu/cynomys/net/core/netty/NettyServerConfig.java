...
public class NettyServerConfig {
    ...
    private int serverSocketSndBufSize = NettyNetConfig.SOCKET_SND_BUF_SIZE;
    private int serverSocketRcvBufSize = NettyNetConfig.SOCKET_RCV_BUF_SIZE;
    ...
    private int serverSocketMaxFrameLength = NettyNetConfig.SOCKET_MAX_FRAME_LENGTH;
